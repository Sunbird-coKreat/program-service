              ...
              if (question !== undefined) {
                ...
                if (question[0].type === "COMPREHENSION") {
                  ...
                  question[0].Questions.map((item) => {
                    arr.push(formatview(item, count,question[0].QuestionIndex));
                    count++
                  });
                  ...
                  let count = 0;
                  arr.push(formatview(question[0].heading, count,question[0].QuestionIndex));
                  arr.push(
                    new Paragraph({
                      children: [], // Just newline without text
                    })
  ...
  if (typeof data === "object") {
    return new TableCell({
      ...
      margins: {
        top: convertInchesToTwip(0.0693701),
        bottom: convertInchesToTwip(0.0693701),
        left: convertInchesToTwip(0.1693701),
        right: convertInchesToTwip(0.0693701),
      },
      verticalAlign: VerticalAlign.CENTER,
      children: [
...
function formatview(data,count,questionCounter){
  if(count === 0){
  return new Table({
    borders:MCQborder,
    columnWidths:[300, 8500, 300],
    rows: [
      new TableRow({
        indent: {
          left: 100,
        ...
        children: [
          displayQueNum(questionCounter), displayViewData(data),displayQueNum("1")
        ]
      })
    ]
  })
  ...
  return new Table({
    ...
    rows: [
      new TableRow({
        ...
        children: [
          displayQueNum(""), displayViewData(data),displayQueNum("")
        ]
      })
    ]
  })
